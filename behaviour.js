...
if (
  ...
  document.querySelector("#pesan_p1").innerHTML = "You WIN!";
  document.querySelector("#pesan_p2").innerHTML = "You LOSE!";
...
if (
  (p2_batu && p1_gunting) ||
  (p2_gunting && p1_kertas) ||
  (p2_kertas && p1_batu)
) {
  document.querySelector("#pesan_p2").innerHTML = "You WIN!";
  document.querySelector("#pesan_p1").innerHTML = "You LOSE!";
  document.querySelector("#pesan_p2").classList.add("menang");
  document.querySelector("#pesan_p1").classList.add("kalah");
}
//p1 & p2 seri
if (acak == acak2) {
  document.querySelector("#pesan_p1").innerHTML = "DRAW!";
  document.querySelector("#pesan_p2").innerHTML = "DRAW!";
